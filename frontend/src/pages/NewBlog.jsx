...
export default function NewBlog() {
    ...
    const handleSave = () => {
        if(newBlog.topic.length > 0 && newBlog.content.length > 0) {
            createBlog(newBlog);
        } else {
            toast('Please provide a blog topic and content', {type: 'error'})
        }
    }
    ...
    const handleGenerate = () => {
        ...
        setNewBlog({
            topic: lorem.generateSentences(1),
        ...
        <MainContainer>
            <Container maxWidth="md" sx={{py: 2, my: 1, backgroundColor: 'silver'}} component={Paper}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <TextField
                            label="Topic" value={newBlog.topic}
                    ...
                    <Grid item >
                        <Stack spacing={2} direction="row">
                            ...
                            <Button variant='outlined' onClick={e => setNewBlog({topic: '', content: ''})}>Clear</Button>
